...
reg_coefs.to_excel('../results/elasticnet_reg_coefs.xlsx', index=False)
gs_crossvalidation_results.to_excel('../results/elasticnet_cv_results.xlsx', index=False)
...
with open('../results/elasticnet_metrics.json', 'w') as f:
    json.dump(metrics, f)